...
class Registernafmo extends CI_Controller {
...
//        }
    ...
    public function index(){
        $data = array();
        $data['title']       = "Register";
//		$user_session_id=$_COOKIE['user_session_id'];
        $user_session_id="MOBI_SESSION";
...
//        $params['session_id'] = $_COOKIE['user_session_id'];
        $params['session_id'] = "MOBI_SESSION";
        ...
        $this->load->view('registernafmo',$data);
...
$sql_ip = "INSERT INTO `ip_city_state` (`SNO`, `IP`, `CITY`, `STATE`) VALUES ('','$bro_ip', '$city', '$state')";           $query = $this->db->query($sql_ip);
    ...
    public function submit_register_naf_mobi(){

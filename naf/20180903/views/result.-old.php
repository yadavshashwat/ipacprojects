        ...
        <div class="wrapper">
            <?php include('header.php'); ?>
                <div class="homeMain resultMain">
                    ...
                    </div><div class="resultIn nomiCert">
                        <div class="partAssociate">
                            <div class="copyCode">
                                <input type="text" id="myInput" value="<?php echo base_url()?>referral/<?php echo $user_detail['registration_number']?>"><div class="btn transition" onclick="copyToClipBoard()">Copy</div>
                            </div>
                            <p class="voteScore">You have <?php echo $my_assoc_count?> / 100 votes on your link</p>
                        </div>
                    </div>

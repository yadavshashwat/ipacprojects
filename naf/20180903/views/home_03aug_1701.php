...
<link rel="stylesheet" href="https://res.cloudinary.com/indianpac/raw/upload/v1533164846/naf/minified_css/owl-partner.carousel.min.css">
...
<style>
    /*.firstActiveItem {*/
        /*padding: 1.250em 0em 1.250em 1.377em;transition: all 0.5s;*/
    /*}*/

    /*.thirdActiveItem {*/
        /*padding: 1.250em 0em 0.625em 0.938em;transition: all 0.5s;*/
    /*}*/

    /*.secondActiveItem {*/
        /*padding: 1.250em 0em 0.625em 1.250em;transition: all 0.5s;*/
    /*}*/

    /*.lastActiveItem {*/
        /*padding: 1.250em 0.625em 0.625em 0.625em;transition: all 0.5s;*/
    /*}*/
...
<style scoped>
	...
	.recent-leader-content .recent-agenda-vote{
		border: 3px solid #002D56;
		background: transparent;
		color: #002D56;
		line-height: 28px;
	...
	.recent-leader-content .recent-agenda-vote:hover{
		    background: #002D56;
    color: white;
...
<div class="recent-plan-wrapper">
  <div class="recent-plan-quote">
    <h1> An attempt to resurrect the conversation and use it to re-imagine and co-create an actionable agenda for contemporary India </h1>
  </div>
  <div class="recent-plan-content-wrapper" id="digi_counter">
    <div class="recent-set-the-agenda">
      <div class="recent-agenda-wrapper"> <img src="https://res.cloudinary.com/indianpac/image/upload/naf/images/icons/agenda-icon-recent.png" alt="Set Agenda" title="Set Agenda"> </div>
    ...
    <div class="recent-choose-the-leader">
      <div class="recent-leader-wrapper"> <img src="https://res.cloudinary.com/indianpac/image/upload/naf/images/icons/choose-the-leader-icon-recent.png" alt="choose leader" title="choose leader"> </div>
      <div class="recent-leader-content">
        ...
        <div class="btn transition recent-agenda-vote" id="Choose_the_leader">Vote</div>
        </a>
    ...
    <div class="recent-naf-eco-system">
      <div class="recent-naf-eco-system-wrapper"> <img src="https://res.cloudinary.com/indianpac/image/upload/naf/images/icons/ecosystem-icon-recent.png"/> </div>
      <div class="recent-naf-eco-system-conent" id="digi_counter">
        ...
        <div class="recent-people-organisations">
          ...
          <div class="recent-orgi">
            <div class="digi-7 digi-orgi counter-value" data-count="<?php echo count($part_count);?>"> 0 </div>
            <div class="digi-sub-heading">Organizations</div>
          </div>
        </div>
        <div class="recent-associates-influencers">
          <div class="recent-associates">
            <div class="digi-7 digi-asso counter-value" data-count="<?php echo count($asso_count);?>"> 15000 </div>
            <div class="digi-sub-heading">Associates</div>
          </div>
          <div class="recent-influencers">
            <div class="digi-7 digi-influ counter-value" data-count="<?php echo count($testi_count);?>"> 0 </div>
...
<div class="about_naf_container">
<div class="about_naf_heading">
    <h4>How relevant is Gandhi’s 18-point Constructive Programme<br/> for today’s India ?</h4>
  </div>
  <div class="charkha_svg">
      <div style="width: 0;" id="float"> <img src="https://res.cloudinary.com/indianpac/image/upload/v1533168734/naf/images/icons/charkha_2.gif" height="30px" width="64px" style="margin-bottom:-4px;transform: scaleX(-1);left:0px;"> </div>
      <hr width="238px" align="left" style="margin-top:-2px;border-color: black;">
    </div>
<div class="container">
  
  <div class="explainer_section">
    
    <div class="naf_ex_left">
      <h2>ABOUT NAF</h2>
      <p>As the nation celebrates the 150th Birth Anniversary year of Mahatma Gandhi, Indian Political Action Committee (I-PAC) launches the National Agenda Forum (NAF), a pan-India initiative to resurrect the conversation around his 18-point Constructive Programme  and use it to re-imagine and co-create India’s priorities to formulate an actionable agenda for contemporary India. </p>
    </div>
    <div class="naf_ex_right" id="videocontainer"> <img src="https://res.cloudinary.com/indianpac/image/upload/v1533168804/naf/images/icons/gph.png" onclick="document.getElementById('videocontainer').innerHTML = embedCode;" width="100%" height="100%" /> </div>
  </div>
  </div>
</div>
<div class="sli">
  <div class="sli1">
    <h2><?php echo count($testi_count);?> Influencers, <?php echo count($part_count);?> Organizations, and <?php echo count($asso_count);?> Associates <br/>have joined the ever-growing NAF ecosystem</h2>
  </div>
    <div class="sli2">
        <img style="width:238px;" src="<?php echo base_url().'assets/news/sli_glass.png'; ?>">
    </div>
  <div class="container" style="padding-bottom: 0px;padding-left: 0px;"> <span style="font-weight: 700;font-size: 1.5em" class="support_title">Support for NAF</span>
  ...
  <div class="sli3">
    <div class="testimonial-section" id="sinfluencers"> 
      ...
      <div class="testimonial-body-flex">
        ...
        <div class="customPrevBtnTestimonial"><img src="https://res.cloudinary.com/indianpac/image/upload/v1533224475/naf/images/icons/arrow-left-afteredit.png"></div>
        <div class="customNextBtnTestimonial"><img src="https://res.cloudinary.com/indianpac/image/upload/v1533224475/naf/images/icons/arrow-right-afteredit.png"></div>
    ...
    <div class="testimonial-section" id="sorganisations"> 
      ...
      <div class="testimonial-body-flex">
        ...
        <div class="customPrevBtnPartner"><img src="https://res.cloudinary.com/indianpac/image/upload/v1533224475/naf/images/icons/arrow-left-afteredit.png"></div>
        <div class="customNextBtnPartner"><img src="https://res.cloudinary.com/indianpac/image/upload/v1533224475/naf/images/icons/arrow-right-afteredit.png"></div>
        <div class="owl-carousel-partner owl-theme"> </div>
      </div>
    </div>
    <div class="testimonial-section-pta" id="sassociates">
      <div class="pta-body-flex">
        ...
        <div class="customPrevBtnPta"><img src="https://res.cloudinary.com/indianpac/image/upload/v1533224475/naf/images/icons/arrow-left-afteredit.png"></div>
        <div class="customNextBtnPta"><img src="https://res.cloudinary.com/indianpac/image/upload/v1533224475/naf/images/icons/arrow-right-afteredit.png"></div>
        <div class="owl-carousel-pta owl-theme-pta"> </div>
      </div>
    </div>
  </div>
</div>
...
<style type="text/css">
    ...
    * {box-sizing: border-box}
    ...
    /* Slideshow container */
    .slideshow-container {max-width: 1000px;position: relative;padding-top: 40px;flex: 1; /* margin: auto; */padding-left: 86px;padding-right: 80px;box-sizing: border-box; width: 50%}
    ...
    .news_slider {color: #fff;max-width: 1920px;width:100%;margin: 0 auto;float:left}
    .bottom_section {display: flex;flex-direction: row;margin: auto;}
    .mySlides {background: #fff;padding: 2%;border-radius: 0px; width: 80%; margin:auto; -ms-transform: skewX(-7deg);
        -webkit-transform: skewX(-7deg);min-height: 175px;transform: skewX(-7deg) !important;}
    .slide_Content {display: flex;flex-direction: row;color: #000; margin-top: 23px;transform: skewX(7deg) !important;}
    ...
    .slide_img img { padding-right: 10px;}
    .Slide_text h4 {margin: 0px;font-size:1.1rem; }
    .Slide_text p { margin-top: 10px;}
    .Slide_text a {color: #c36300;}
    .milstone {  flex: 1;padding-top: 40px; padding-bottom: 30px;background: #424242; position: relative; padding-right: 50px;padding-left: 88px;}
    ...
    .milstone ul li h6 {font-size: 16px;margin: 0px;font-weight: 400;}
    ...
    .previous_block{ display: block;
        ...
        z-index: 1;
        opacity: 0.5;
        transform: scale(.8) skewX(-7deg) !important; }
    ...
    @media only screen and (max-width: 1600px) {.slide_inner_box {min-height: 350px;max-height: 100%;}}
    ...
    @media only screen and (max-width: 1260px) {.slide_inner_box {min-height: 450px;max-height: 100%;}
        .swiper-container{height:435px;!important;}.mySlides{min-height: 218px;}
        .slideshow-container{ padding-left: 15px;padding-right: 15px;}
    }
    @media only screen and (max-width: 1080px) {.slide_inner_box {min-height: 290px;max-height: 100%;}
        .slideshow-container {padding: 60px 90px;max-width: none;}
        .swiper-container{width:80%;height:180px;!important;}
    }
    @media only screen and (max-width: 768px) {.slide_inner_box {min-height: 390px;max-height: 100%;}
        .mySlides{ width:100%;transform: skewX(0deg) !important;}
        .slide_Content{ transform: skewX(0deg) !important;}
        .previous_block{ transform: skewX(0deg) !important;}
        .next_block{ transform: skewX(0deg) !important;}
        .slideshow-container h1{ padding: 20px 0px 0px 30px; }
        .slideshow-container{ padding: 0px;}
        .swiper-container{width:84%;height:215px; } .swiper-button-next{display: none;}  .swiper-button-prev{display: none;}}
    @media only screen and (max-width: 640px) {.slide_inner_box {min-height: 420px;max-height: 100%;}
        .mySlides{ width:100%;transform: skewX(0deg) !important;}
        .slide_Content{ transform: skewX(0deg) !important;}
        .previous_block{ transform: skewX(0deg) !important;}
        .next_block{ transform: skewX(0deg) !important;}
        .slideshow-container h1{ padding: 20px 0px 0px 30px; }
        .slideshow-container{ padding: 0px;}
        .swiper-container{width:88%} .swiper-button-next{display: none;}  .swiper-button-prev{display: none;}}
    @media only screen and (max-width: 480px) {.slide_inner_box {min-height: 460px;max-height: 100%;}
        .mySlides{ width:100%;transform: skewX(0deg) !important;}
        .slide_Content{ transform: skewX(0deg) !important;}
        .previous_block{ transform: skewX(0deg) !important;}
        .next_block{ transform: skewX(0deg) !important;}
        .slideshow-container h1{ padding: 20px 0px 0px 30px; }
        .slideshow-container{ padding: 0px;}
        .swiper-container{width:80%;height:180px;!important;} .swiper-button-next{display: none;}  .swiper-button-prev{display: none;}}
    @media only screen and (max-width: 380px) {
        .slide_inner_box {min-height: 400px;max-height: 100%;
        .mySlides{ width:100%;transform: skewX(0deg) !important;}
        .slide_Content{ transform: skewX(0deg) !important;}
        .previous_block{ transform: skewX(0deg) !important;}
        .next_block{ transform: skewX(0deg) !important;}
        .slideshow-container h1{ padding: 20px 0px 0px 30px; }
        .slideshow-container{ padding: 0px;}
    }.swiper-container{width:92%;height:135px;!important;} .swiper-button-next{display: none;}  .swiper-button-prev{display: none;}}
    /** NEWS SLIDER CSS END */
</style>
<div class="news_slider" style="background: #2a2a2a;">
    <div class="bottom_section">
        <div class="slideshow-container">
            <h1 style="font-size:22px;color: #cacaca">IN THE NEWS</h1>
            <br/>
            <?php if(count($news)){ ?>
                        ...
                        <div class="mySlides">
                            <div class="slide_Content">
                                ...
                                <div class="Slide_text">
                                    ...
                                    <a href="<?php echo $new['news_link']; ?>" target="_blank">Read More</a> </div>
                            </div>
                        </div>
                    <?php } ?>
                </div>
        ...
        <div class="milstone">
            <h1 style="font-size:22px;color: #cacaca">MILESTONES</h1>
            <br/>
            <ul>
                <li>
...
//            $(".owl-carousel-trending").owlCarousel();
			...
			var owlTrending = $('.owl-carousel-trending');
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $.each(firstPtaArray, function( index, value ) {
                        ptaCarousel += "<div class=\"sli_part\"><div class=\"sli_part1\"><div class=\"sli_part1_icon\"><img src=\"https://www.indianpac.com/naf/assets/news/sli_side_logo.png\" class=\"sli_side_logo\"></div><div class=\"sli_part2\"><img src=\"https://res.cloudinary.com/indianpac/image/upload/v1533155659/naf/images/pta_performers_new/"+ value.image_id +"\"></div><div class=\"sli_part3\"><h3>" + value.name + "</h3><p>" + value.college_name + "</p></div></div></div>";
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $.each(result, function( index, value ) {
                        testimonialCarousel += "<div class=\"sli_part\"><div class=\"sli_part1\"><div class=\"sli_part1_icon\"><img src=\"https://www.indianpac.com/naf/assets/news/sli_side_logo.png\" class=\"sli_side_logo\"></div><div class=\"sli_part2\"><div class=\"sli_part2_sub1\"><center><img src=\"https://www.ipactesting.com/hepta/assets/news/sli_quto.png\" class\"sli_quto\"  style=\"width:30px;\"></center><p>" + value.testimonial + "</p></div><img src=\"https://res.cloudinary.com/indianpac/image/upload/v1533231332/naf/images/testimonial_naf/"+ value.author_image +"\" class=\"testimonial_img\"></div><div class=\"sli_part3\"><h3>" + value.author + "</h3><p>" + value.designation + "</p></div></div></div>"
                    ...
                    //
                    //     $('.owl-carousel .owl-stage .owl-item').removeClass('firstActiveItem lastActiveItem secondActiveItem thirdActiveItem');
                    //
			...
			// make the API call get first 4 rows from DB
            $.ajax({
                url: "<?php echo base_url(); ?>home/getPartners",
                dataType: "JSON",
                type: "GET",
                cache: false,
                contentType: false,
                processData: false,
                success: function(result) {
					owlpartner.trigger('destroy.owl.carousel');
                    owlpartner.find('.owl-stage-outer').children().unwrap();
                    owlpartner.removeClass("owl-center owl-loaded owl-text-select-on");
                    // add the new items
                    $.each(result, function( index, value ) {
                        partnerCarousel += "<div class=\"sli_part\"><div class=\"sli_part1\"><div class=\"sli_part1_icon\"><img src=\"https://www.indianpac.com/naf/assets/news/sli_side_logo.png\" class=\"sli_side_logo\"></div><div class=\"sli_part2\"><div class=\"sli_part2_sub1\"><p>" + value.bio + "</p></div><img src=\"https://res.cloudinary.com/indianpac/image/upload/v1533155702/naf/images/organizations/"+ value.partner_image_name +"\" class=\"partner_img\"></div><div class=\"sli_part3\"><h3>" + value.partner_name + "</h3></div></div></div>"
                        lastItemIndexPartner = parseInt(value.id);
                    });
                    owlpartner.html(partnerCarousel);
                    //reinitialize the carousel (call here your method in which you've set specific carousel properties)
                    owlpartner.owlCarousel({
                        dots: false,
                        loop: true,
			...
			$.ajax({
                url: "<?php echo base_url(); ?>home/getTrendings",
                dataType: "JSON",
                type: "GET",
                cache: false,
                contentType: false,
                processData: false,
                success: function(result) {
					owlTrending.trigger('destroy.owl.carousel');
                    owlTrending.find('.owl-stage-outer').children().unwrap();
                    owlTrending.removeClass("owl-center owl-loaded owl-text-select-on");
                    // add the new items
                    $.each(result, function( index, value ) {
                        trendingCarousel += "<div class=\"trending-banner-wrapper\"><img src=\"https://res.cloudinary.com/indianpac/image/upload/v1533162639/naf/images/banners/"+ value.image_name + "\"/></div>"
                    });
                    owlTrending.html(trendingCarousel);
                    //reinitialize the carousel (call here your method in which you've set specific carousel properties)
                    owlTrending.owlCarousel({
						nav:true,
						dots:true,
			...
			// Go to the next item
            $('.customNextBtnPartner').click(function() {

                if(lastItemIndexPartner === partnerTotalCount){
                    owlpartner.trigger('next.owl.carousel', [300]);
                    return;
                }
                $.ajax({
                    url: "<?php echo base_url(); ?>home/next_partners",
                    data: {'item_count':lastItemIndexPartner},
                    dataType: "JSON",
                    type: "POST",
                    success: function(result) {
                        // console.log(result);
                        $.each(result, function( index, value ) {
                            partnerCarousel = "<div class=\"sli_part\"><div class=\"sli_part1\"><div class=\"sli_part1_icon\"><img src=\"https://www.indianpac.com/naf/assets/news/sli_side_logo.png\" class=\"sli_side_logo\"></div><div class=\"sli_part2\"><div class=\"sli_part2_sub1\"><p>" + value.bio + "</p></div><img src=\"https://res.cloudinary.com/indianpac/image/upload/v1533155702/naf/images/organizations/"+ value.partner_image_name +"\" class=\"partner_img\"></div><div class=\"sli_part3\"><h3>" + value.partner_name + "</h3></div></div></div>";
                            owlpartner.trigger('add.owl.carousel',[partnerCarousel]).trigger('refresh.owl.carousel');
                            lastItemIndexPartner = parseInt(value.id);
                        });
                ...
                if(testimonialTotalCount === lastItemIndexTestimonial){
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            console.log(result);
                            $.each(result, function( index, value ) {
                                testimonialCarousel = "<div class=\"sli_part\"><div class=\"sli_part1\"><div class=\"sli_part1_icon\"><img src=\"https://www.indianpac.com/naf/assets/news/sli_side_logo.png\" class=\"sli_side_logo\"></div><div class=\"sli_part2\"><div class=\"sli_part2_sub1\"><center><img src=\"https://www.indianpac.com/naf/assets/news/sli_quto.png\" class\"sli_quto\"  style=\"width:30px;\"></center><p>" + value.testimonial + "</p></div><img src=\"https://res.cloudinary.com/indianpac/image/upload/v1533231332/naf/images/testimonial_naf/"+ value.author_image +"\" class=\"testimonial_img\"></div><div class=\"sli_part3\"><h3>" + value.author + "</h3><p>" + value.designation + "</p></div></div></div>";
                                owl.trigger('add.owl.carousel',[testimonialCarousel]).trigger('refresh.owl.carousel');
                                lastItemIndexTestimonial = parseInt(value.id);
                            });
                            owl.trigger('prev.owl.carousel', [300]);
			...
			// Go to the previous item
            $('.customPrevBtnPartner').click(function() {
                // With optional speed parameter
                // Parameters has to be in square bracket '[]'
                if(partnerTotalCount === lastItemIndexPartner){
...
<script type="text/javascript">
    var embedCode = '<iframe width="560" height="315" src="https://www.youtube.com/embed/CCfe9rEb72s?autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
</script>

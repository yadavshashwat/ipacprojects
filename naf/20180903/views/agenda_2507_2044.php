  ...
  <div class="homeMain agendaMain">
    <div class="headSearch ">
      ...
      <div class="topInfo"> 
        ...
        <p>You can choose maximum 10 agenda points, including adding a new agenda item in the box below</p>
      </div>
<div id="counter"><span id="left_count">0</span>/10 </div>
      ...
      <form name="agenda_form" id="agenda_form">
        ...
        <div class="agendaWrap">
          <h2>Gathered from peoples&rsquo; inputs</h2>
          <?php $j=1; foreach ($agenda_list as $key => $value) {?>
          <div class="agendaOut <?php echo "agendacls".$value['id'];?> <?php if(in_array($value['id'], $selected_agenda['agenda_list'])){ echo 'selectedOpt';}?>" id="selectedOpt">
            <div class="container">
              <div class="table_cell"> 
          ...
          <?php $j++; }?>
                   ...
                   <div class="agendaOut agendacls9" id="test" style="visibility: hidden;">BRO TUM</div>


        </div>

<script>
//function add_pep_agenda(){
 // y=document.getElementById('new_agenda').value;
        ...
        <div class="agendaWrap">
          ...
          <div class="transition addAgenda" id="add_agenda_sec">
            <div class="container transition"> 
              ...
              <textarea maxlength="300" placeholder="Add New Agenda" name="new_agenda" id="new_agenda" oninput="checkFilled(12)"><?php echo $selected_agenda['new_agenda'];?></textarea>
            ...
            function checkboxCheked(){
                ...
                if(total >= 1 && total < 10){
                    ...
                    if(newAgenda==''){
                     ...
                     $('.agendaOut').addClass('disabled');
                    $('.selectedOpt').removeClass('disabled');
                }if(total < 1){

<footer>
    <div class="footerIn">
        <ul>
            ...
            <?php if($langcookie=="en"){?><a  href="<?php echo base_url() ?>assets/images/NAF_Concept_Note_English.pdf" target="_blank"><?php } if($langcookie=="hi"){ ?><a href="<?php echo base_url() ?>assets/images/NAF_Concept_Note_Hindi.pdf" target="_blank"><?php }?>
...
नियम और शर्तें<?php }?></li>
        ...
        <div class="copyright">
            ...
            <div class="follow_flex">
                ...
                <a href="https://www.instagram.com/indianPAC/" target="_blank" style="float:left;line-height: 0px"><img
                            height="30px" src="<?php echo base_url() ?>assets/images/insta.png"/></a>
        ...
        <div class="table_cell">
            <div class="popupData">
                ...
                <h5 style="margin-top: 20px;margin-bottom: 0;">You have not registered yet. </h5><br>
                                <?php 
                                    if (($disable_agenda) == 0 || ($disable_vote) == 0 ){
                                ?>
                                      <div style="text-align: center;"><em style="position: relative;top: -10px;font-size: 15px;">Make sure
                                       ...
                                       <a href="<?php echo base_url();?>agenda"><div class="btn btn-popup transition">Set The Agenda</div></a>
                                <?php
                                    }else{ 
                                ?>
                                    <div style="text-align: center;"><em style="position: relative;top: -10px;font-size: 15px;">Make sure
                                        you have already registered to see the result.</em></div>
                                    <a href="<?php echo base_url();?>register"><div class="btn  btn-popup transition">Register</div></a>
                                <?php
                                    }
                                ?>
    ...
    <div class="popupIn">
        <div class="table_cell">
            <div class="popupData">
                ...
                <h5>Enter OTP</h5>
                <form name="otp_submit1" id="otp_submit1" autocomplete="off">
...
<?php }?>
                    ...
                    <div class="qtnOut">
                        ...
                        <?php if($langcookie=="en"){?><p>By voting and then filling out the registration form on the website</p><?php } if($langcookie=="hi"){ ?><a
                                    href="http://www.indianpac.com/naf/" target="_blank">www.indianpac.com/naf</a> पर वोट ऐंव वेबसाइट मैं रजिस्ट्रेशन फॉर्म भरके |<?php }?>
...
<script>
function Hindi(){
	document.cookie = "language=hi; expires=Wed, 2 Oct 2019 12:00:00 UTC; path=/";
...
function English(){
	document.cookie = "language=en; expires=Wed, 2 oct 2019 12:00:00 UTC; path=/";
    window.location.href = window.location.href.split("?")[0];

...
<div class="container">
    <div class="row">
        <?php
        if(count($Organization_partner) > 0){
            foreach ($Organization_partner as $partner) {
                ?>
                <div class="influencers-box col-md-4 col-lg-3 col-xs-12 col-sm-6">
                    <div class="sli_part">
                        <div class="sli_part1">
                            <div class="sli_part1_icon"><img
                                        src="https://res.cloudinary.com/indianpac/image/upload/v1533721334/sli_side_logo_black-new-min.png"
                                        class="sli_side_logo"></div>
                            <div class="sli_part2">
                                <div class="sli_part2_sub1"><p><?php echo $partner->bio; ?></p></div>
                                <img src="https://res.cloudinary.com/indianpac/image/upload/v1533155702/naf/images/organizations/<?php echo $partner->partner_image_name; ?>"
                                     class="partner_img"></div>
                            <div class="sli_part3"><h3><?php echo $partner->partner_name; ?></h3></div>
                        </div>
                    </div>
                </div>
                <?php

    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#shareBtn').click(function (e) {
                FB.ui(
                    {
                        quote:'Gandhiji, in his Constructive Programme (https://goo.gl/Qpphxj), had outlined the blueprint for independent India. In his 150th Birth Anniversary year, let us spread his vision & formulate an actionable agenda for India. Join #NationalAgendaForum, visit www.indianpac.com/naf/',
    method: 'share',
    mobile_iframe: true,
    href: 'http://indianpac.com/naf/'
                    }
                );
            });
        });

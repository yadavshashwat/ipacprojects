...
<meta name="description" content="" />
    <link rel="stylesheet" href="https://res.cloudinary.com/indianpac/raw/upload/naf/minified_css/owl-pta.carousel.min.css">
    <link rel="stylesheet" href="https://res.cloudinary.com/indianpac/raw/upload/naf/minified_css/owl.carousel.min.css">
    <link rel="stylesheet" href="https://res.cloudinary.com/indianpac/raw/upload/naf/minified_css/owl.theme.default.min.css">
    <link rel="stylesheet" href="https://res.cloudinary.com/indianpac/raw/upload/naf/minified_css/owl-pta.theme.default.min.css">
	<style>
		.map_active{
			background: #8080803b;
		}
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W7QK3P9"
...
<div class="header-wrapper">
  <div class="wrapper topWrap">
    ...
    <div ></div>
    <img class="gandhiBack" src="https://res.cloudinary.com/indianpac/image/upload/naf/images/gandhi.png"><img class="gandhiBack3" src="https://res.cloudinary.com/indianpac/image/upload/naf/images/gandhi-charkha-naf.png">
  ...
  <div class="stepsIn"> 
    ...
    <div class="stepsIn"> 
      ...
      <div class="stein_right">
        ...
        <?php if($disable_vote){?><div class="btn transition disable blackdisable">Done</div><?php }else{?><a href="<?php echo base_url();?>vote"><div class="btn transition">Vote</div></a><?php }?>
        <?php if(isset($total_leader_voted_count)){ ?>
        <!--<p class="stats" style="margin-top:22px;"></p> --> 
  ...
  <div class="wrapper"> 
    ...
    <div class="testimonial-section"> 
      ...
      <blockquote style="text-align: center;">
        <div class="subheading-support-to-naf"><b>108</b> eminent personalities across <b>20</b> states have extended their support to NAF</div>
      </blockquote>
        <!-- Testimonial body-->
...
<!--			--><?php
//            $numItems = count($testimonial_list);
//            $i = 0;
//            //print_r($next_testimonial_data);
//			foreach ($testimonial_list as $key1 => $value1) {
//			?>
<!--			<div class="item-testimonial --><?php //echo $value1['bg_color'];?><!--">-->
<!--            <img src="https://res.cloudinary.com/indianpac/image/upload/naf/images/--><?php //echo $value1['author_image'];?><!--" style="height: 200px;width: 200px;border-radius: 50%;margin: 20px auto;"/>-->
...
//                   ?>
<!--                    <form>-->
<!--                        <input type="hidden" id="last_index_testimonial" name="last_index_testimonial" value="--><?php //echo $value1['id'];?><!--">-->
<!--                    </form>-->
<!--            --><?php
//
//                };
...
<blockquote style="text-align: center;">
    ...
    <div class="testimonial-section-pta"> 
      ...
      <blockquote style="text-align: center;">
        <div class="subheading-support-to-naf" style="color:white;"> <b>27,000+</b> students from <b>2200+</b> colleges across <b>600+</b> districts of India have come together to launch NAF </div>
      </blockquote>
...
<!--        <div class="item" style="text-align: center"> <img src="https://res.cloudinary.com/indianpac/image/upload/naf/images/top_pta_performers/--><?php //echo $value['image_id']?><!--.jpg" style="height: 200px;width: 200px;border-radius: 50%;margin: 20px auto;"/>-->
...
<div class="news-social-feed-flex">
	<div class="last_section">
        ...
        <?php foreach ($news as $key2 => $value2) {?>
			<div class="news1">
				<div class="news_left">
					<a href="<?php echo $value2['news_link']; ?>" target="_blank"><img src="https://res.cloudinary.com/indianpac/image/upload/naf/images/news/<?php echo $value2['news_img_name']; ?>" /></a>
				</div>
...
<script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            /**
             * Testimonial Logic ti improve performance
             * */

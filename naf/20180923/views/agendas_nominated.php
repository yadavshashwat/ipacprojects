        ...
        <div class="col-md-12  table-responsive">
            <table style="border-collapse: collapse;" class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-left">Agendas Nominated</th>
                </tr>
                </thead>
                <tbody>
                <?php
				...
				$i=1;
                    foreach ($getnoninatedagresults as $index => $agendas_nominated) {
                        ?>
                        <tr>
                        <td class="text-left"><?php echo $i; ?></td>
                            <td class="text-left"><?php echo $agendas_nominated['agenda_nominated']; ?></td>

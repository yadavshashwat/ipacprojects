        ...
        <div class="col-md-12  table-responsive">
            <table style="border-collapse: collapse;" class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-left">Leaders Nominated</th>
                </tr>
                </thead>
                <tbody>
                <?php
				...
				$i=1;
                    foreach ($getnoninatedldresults as $index => $leaders_nominated) {
                        ?>
                        <tr>
                        <td class="text-left"><?php echo $i; ?></td>
                            <td class="text-left"><?php echo $leaders_nominated['leader_nominated']; ?></td>

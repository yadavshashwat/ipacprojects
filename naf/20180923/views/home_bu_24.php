    ...
    <div class="testimonial-section"> 
      ...
      <div class="testimonial-body-flex">
        <div class="owl-carousel owl-theme">
			<?php  
			foreach ($testimonial_list as $key1 => $value1) {
			?>
			<div class="item-testimonial <?php echo $value1['bg_color'];?>">
            <img src="<?php echo base_url() ?>assets/images/<?php echo $value1['author_image'];?>" style="height: 200px;width: 200px;border-radius: 50%;margin: 20px auto;"/>
			  <div class="testimonial-author-name"><?php echo $value1['author'];?></div>
			  <div class="testimonial-author-name designation-testimonial"><?php echo $value1['designation'];?></div>
				<div class="testimonial-content">
					<i class="fa fa-quote-left" style="font-size:16px;margin-right: 5px;margin-right: 5px;color: #767676;"></i><?php echo $value1['testimonial'];?><i class="fa fa-quote-right" style="font-size:16px;margin-left: 5px;margin-right: 5px;color: #767676;"></i>
				</div>            
			</div>
			<?php }?>
        </div>
...
<div class="news-social-feed-flex">
	<div class="last_section">
        ...
        <?php foreach ($news as $key2 => $value2) {?>
			<div class="news1">
				<div class="news_left">
					<a href="<?php echo $value2['news_link']; ?>" target="_blank"><img src="<?php echo base_url()?>assets/news/<?php echo $value2['news_img_name']; ?>" /></a>
				</div>

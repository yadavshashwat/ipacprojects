<header>
	<div class="headIn">
		<div class="logo-wrapper inner_page_head"><a href="<?php echo base_url();?>">

                <?php if($langcookie=="en"){ ?>
                    <img class="logo inner_logo" src="<?php echo base_url()?>assets/images/innerNAF.png"></a>
                <?php }?>
                <?php if($langcookie=="hi"){ ?>
                    <img class="logo inner_logo" style="height: 50px!important;" src="https://res.cloudinary.com/indianpac/image/upload/naf/images/icons/NAF-logo-hindi_back-min.png"></a>
                <?php }?>


            <div class="site_naf_lang" style="float: right;position: relative;z-index: 999;margin-top: 10px;margin-bottom: 10px;"><div onclick="Hindi()" style="padding-right: 5px;float: left;background: linear-gradient(to right, #f79f45 0%, #278747 100%);
    -webkit-background-clip: text;-webkit-text-fill-color: transparent;cursor: pointer;font-size: 12px;">हिंदी  &nbsp;|</div><div onclick="English()" style="padding-left: 2px;float: left;
    background: linear-gradient(to right,#000654 0%, #ff0000 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;cursor: pointer;font-size: 12px;">English</div></div></div><!--<img class="name" src="<?php echo base_url()?>assets/images/name.png">--><!-- <div class="name">
            ...
            <div class="btn resultBtn transition">View Result</div>
				...
				?>
					<form id="pta_form1" name="pta_form1" autocomplete="off" method="POST">
						<div class="indiaCode">+91</div><input class="mobileNumber" type="text" placeholder="Enter Your Mobile Number" name="pta_mobile_number" id="pta_mobile_number" autocomplete="off" maxlength="10" minlength="10"><input type="submit" class="btn submitBtn" value="GET OTP">
		...
		<!--</div>-->
        <div class="gandhiBack"></div>
		<!--<div class="aboutNAF naf-logo"><div class="inner-wrap"><img src="<?php echo base_url()?>assets/images/NAF.png" alt="naf-logo"></div></div>
		<div class="aboutNAF naf-logo-mobile"><div class="inner-wrap"><img src="<?php echo base_url()?>assets/images/mNAF.png" alt="naf-logo"></div></div>-->

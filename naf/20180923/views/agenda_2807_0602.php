  ...
  <div class="homeMain agendaMain">
    <div class="headSearch">
      ...
      <form name="agenda_form" id="agenda_form">
        ...
        <h2><?php if($_COOKIE['language']=="en"){ ?> Agenda Points <?php }?>  <?php if($_COOKIE['language']=="hi"){ ?> एजेंडा बिंदु  <?php }?></h2>
        
        <!--<h4>There is no one who loves pain itself, who seeks after it and wants to have it</h4>-->
        <div class="green-border-down"></div>


        <p style="text-align:center;margin-bottom:30px;"><?php if($_COOKIE['language']=="en"){ ?> You can choose maximum 10 agenda points, including adding a new agenda item in the box below <?php }?> <?php if($_COOKIE['language']=="hi"){ ?> आप  इनमे से ज्यादा से ज्यादा 10 एजेंडा बिन्दुओ का चयन कर सकते है <?php }?></p>
      </div>
          <h2><?php if($_COOKIE['language']=="en"){ ?>Inspired by Gandhiji’s 18-point Constructive Programme <?php }?> <?php if($_COOKIE['language']=="hi"){ ?> गाँधी जी के 18-बिंदु रचनात्मक कार्यक्रम से प्रेरित <?php }?></h2>
          ...
          <div class="agendaOut <?php echo "agendacls".$value['id'];?> <?php if(in_array($value['id'], $selected_agenda['agenda_list'])){ echo 'selectedOpt';}?>" id="selectedOpt">
            <div class="container">
              ...
              <div class="agendatitlenicon">
                <h5><?php if($_COOKIE['language']=="en"){  echo $value['agenda_topic']; }?><?php if($_COOKIE['language']=="hi"){  echo $value['agenda_topic_hindi']; }?></h5>
                ...
                <p class="only_mob_desc"><?php if($_COOKIE['language']=="en"){ ?> Tap to see details <?php }?>  <?php if($_COOKIE['language']=="hi"){ ?> 
...
<?php }?></p>
                ...
                <div class="transition agendaImg" id="gandhi_border"><img id="gandhi_invert" class="transition gandhijiicon" src="<?php echo base_url()?>assets/images/icons/Gandhi4.png"></div>
                 ...
                 <label class="transition" id="agenda_description"><?php if($_COOKIE['language']=="en"){  echo $value['agenda_name']; } ?><?php if($_COOKIE['language']=="hi"){  echo $value['agenda_name_hindi']; } ?></label>
                 </div>
                </div>
              </div>
            </div>
        ...
        <div class="agendaWrap">
          <h2><?php if($_COOKIE['language']=="en"){ ?> Gathered from peoples&rsquo; inputs <?php }?>  <?php if($_COOKIE['language']=="hi"){ ?> जनता द्वारा सुझाए गए  एजेंडा बिंदु 
<?php }?></h2>
...
<!-->
        ...
        <div class="agendaWrap">
          <h2>Add your own agenda point biusdfgdskjhg</h2>

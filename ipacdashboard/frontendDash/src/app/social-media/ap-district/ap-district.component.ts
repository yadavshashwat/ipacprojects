...
@Component({
  selector: 'app-ap-district',
  templateUrl: './ap-district.component.html',
  styleUrls: ['./ap-district.component.css']
})
export class ApDistrictComponent implements OnInit {
  ...
  doEngLineGraph() {
    ...
    this.lineChartEngData = [
      { data: values, label: 'Engaged Users' }
    ];
  ...
  doNfLineGraph() {
    ...
    this.lineChartNfData = [
      { data: values, label: 'Negative feedback' }
    ];
  ...
  navigatePages() {
    this.router.navigate(['dashboards/social-media/ap-district']);
  }
...
@Component({
  selector: 'app-dialog-like-source-dialog',
  templateUrl: 'dialog-like-source.html',
  styleUrls: ['./ap-district.component.css']
})
export class DialogLikeSourceComponent {

  constructor(
    public dialogRef: MatDialogRef<DialogLikeSourceComponent>,
